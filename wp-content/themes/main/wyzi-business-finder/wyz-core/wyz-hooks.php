...
/*alter woocommerce prodect image display*/

/*add_action('woocommerce_before_shop_loop_item_title', function(){
	echo '<div class="prod-fix-height">';
}, 5);
...
//add_action('wp',function(){ echo '<style type="text/css">.navbar-default.sidebar ul ul li a {padding: 10px 30px 10px 85px !important;}</style>';},1);
?>
