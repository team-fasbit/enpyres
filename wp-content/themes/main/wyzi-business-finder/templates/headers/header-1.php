	...
	class WYZIHeader extends WYZIHeaderParent {
		...
		public function start() {
			if ( $this->is_seethrough ) {
				...
				echo '<style>';
				if ( '' != $this->bg_color ) echo '.header-bottom, .main-menu ul.sub-menu { background-color: ' . $this->bg_color . ';}';
				if ( '' != $this->submenu_bg_color ) echo '.main-menu ul.sub-menu { background-color: ' . $this->submenu_bg_color . ';}';
				if ( 'on' != $this->shadow ) echo '.header-bottom, .main-menu li:hover > ul.sub-menu { box-shadow: none;}';
				if ( $this->font_color != '' )
					echo '.main-menu nav > ul > li:hover > a, .main-menu ul > li > a, #main-menu > li.menu-item-has-children .fa,
					 .main-menu > ul > li .fa, .header-links a,.mean-nav > ul > li ul li a,.mean-nav > ul > li ul li a, .sub-menu li a, .mean-nav > ul > li > a, .mean-nav ul li li a, .mean-nav ul li li li a, .meanmenu-reveal .fa,.main-menu nav > ul > li > a, .login-menu > ul > li > a { color: ' . $this->font_color . ';}';
				if ( $this->submenu_font_color != '' )
					echo '.sub-menu li a, .sub-menu li i{ color: ' . $this->submenu_font_color . ';}';
				if ( $this->font_hover_color != '' )
					echo '.main-menu nav > ul > li.current-menu-item > a, .main-menu nav > ul > li:hover > a,.main-menu nav > ul > li:hover> .fa, .login-menu nav > ul > li.current-menu-item > a, .login-menu nav > ul > li:hover > a, .sub-menu li:hover > a, .sub-menu li:hover>a i { color: ' . $this->font_hover_color . ';}';
				if ( $this->font_active_color != '' )
					echo '.main-menu nav ul li.current-menu-item > a, .main-menu nav ul li.current-menu-item:hover > a,
				...
				if ( $has_mobile_style ) {
					...
					if ( '' != $this->mobile_font_color ) echo '.mean-nav > ul > li > a,.mean-nav > ul > li ul li a,.sub-menu li i, .mean-nav ul li li a, .mean-nav ul li li li a, .meanmenu-reveal .fa { color: ' . $this->mobile_font_color . ';}';
					if ( '' != $this->mobile_font_active_color ) echo '.mean-nav ul li.current-menu-item > a, .mean-nav ul li.current-menu-item:hover > a,
					.mean-nav ul li.current-menu-parent > a, .mean-nav ul li.current-menu-parent:hover > a{ color: ' . $this->mobile_font_active_color . ';}';
					if ( '' != $this->mobile_bg_color ) echo '.mean-nav,.header-bottom,.mean-nav > ul > li > a, .sub-menu { background-color: ' . $this->mobile_bg_color . ';}';
					echo '}';
				}
				echo '</style>';
			}
