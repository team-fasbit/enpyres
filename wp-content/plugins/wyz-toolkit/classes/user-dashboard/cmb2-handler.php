	...
	switch ($_GET['page']) {
		case 'add-edit-business':
			if( isset( $_GET[ WyzQueryVars::AddNewBusiness ] ) ) {
				require_once( WYZI_PLUGIN_DIR . 'businesses-and-offers/businesses/front-end-business-submission.php' );
				wyz_handle_frontend_new_business_submission_form();
			} elseif(isset( $_GET[ WyzQueryVars::EditBusiness ])) {
				require_once( WYZI_PLUGIN_DIR . 'businesses-and-offers/businesses/edit-business.php' );
