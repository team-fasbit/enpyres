		...
		foreach ( $data as $key => $value ) {
			...
			switch( $value['type'] ) {
				...
				echo '<tr><th><label for="' . $id . '">' . $value['label'] . ( ! empty( $value['required'] ) ? '<span class="req"> *</span>' : '' ) . '</label></th><td>' .
					'<input name="' . $id . '" class="regular-text" id="' . $id . '" type="' . $value['type'] . '" value="' .  esc_attr( $val ) . '"/>';
					echo '</td></tr>';
				break;
				case 'textarea':
				case 'wysiwyg':
					echo '<tr><th><label for="' . $id . '">' . $value['label'] . ( ! empty( $value['required'] ) ? '<span class="req"> *</span>' : '' ) . '</label></th><td>' .
					'<textarea name="' . $id . '" class="regular-text" id="' . $id . '" type="' . $value['type'] . '">'. esc_attr( $val ) . '</textarea>';
					echo '</td></tr>';
				break;
				case 'selectbox':
					echo '<tr><th><label for="' . $id . '">' . $value['label'] . ( ! empty( $value['required'] ) ? '<span class="req"> *</span>' : '' ) . '</label></th><td>';
...
add_action( 'show_user_profile', 'wyz_add_user_metadata_fields' );
add_action( 'edit_user_profile', 'wyz_add_user_metadata_fields' );
