...
/**
  ...
  */
add_filter( 'wyz_after_register_redirect', 'wyz_redirect_user_to_subscription_after_login_register', 10, 2 );
add_filter( 'wyz_after_login_redirect', 'wyz_redirect_user_to_subscription_after_login_register', 10, 2 );
function wyz_redirect_user_to_subscription_after_login_register( $url, $user ){
	if ( get_option( 'wyz_sub_mode_on_off' ) == 'on' ) {
