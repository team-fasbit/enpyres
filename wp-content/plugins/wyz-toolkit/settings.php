			...
			<div id="poststuff">
					...
					if ( 'admin.php' == $pagenow && isset( $_GET['page'] ) && 'wyzi-toolkit-options' == $_GET['page'] ) {
								...
								<form method="post" action="options.php">
									...
									<table class="form-table">
										...
										<tr valign="top">
											...
											<th scope="row"><?php esc_html_e( 'Job Rquires a Business', 'wyzi-business-finder' );?></th> 
											<td>
												<fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Featured Businesses per Page', 'wyzi-business-finder' ) ;?></th> 
											<td>
											<fieldset><input type="number" name="wyz_featured_posts_perpage" min=0 value="<?php
											echo esc_attr( get_option( 'wyz_featured_posts_perpage', 2 ) ); ?>"/><p class="description"><?php esc_html_e( 'Number of featured businesses to display at the top of the listing, set to 0 to disable', 'wyzi-business-finder' );?></p></fieldset>
											</td>
										</tr>
										<tr valign="top">
											<?php $opt = get_option( 'wyz_businesses_registery_price', 0 );?>
											<th scope="row"><?php esc_html_e( 'Business Registration Cost', 'wyzi-business-finder' );?></th> 
											<td>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Maximum allowed attachments per user', 'wyzi-business-finder' );?></th> 
											<td>
											<fieldset><input type="number" name="wyz_max_attchmtn_count" value="<?php
											echo esc_attr( get_option( 'wyz_max_attchmtn_count', -1 ) ); ?>"/><p class="description"><?php esc_html_e( 'Maximum allowed number of attachments for a user to upload. (-1 for unlimited)', 'wyzi-business-finder' );?></p></fieldset>
											</td>
										</tr>
										<tr valign="top">
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Draft on Expiry', 'wyzi-business-finder' );?></th> 
											<td>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Favorite business', 'wyzi-business-finder' );?></th> 
											<td>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Hide Archives page Header', 'wyzi-business-finder' );?></th>
											<td><fieldset>
												...
												</select><p class="description"><?php esc_html_e( 'Hide map in Business Archives Page.', 'wyzi-business-finder' );?>.</p></fieldset>
											</td>
										</tr>
										<tr valign="top">
											...
											echo esc_attr( get_option( 'wyz_archives_map_zoom', 12 ) ); ?>"/><p class="description"><?php esc_html_e( 'Archives page map zoom level. 0: max zoomed out, 22: max zoomed in. Set to -1 for activate marker autofit.', 'wyzi-business-finder' );?></p></fieldset></td>
										</tr>


										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Archives map sidebar', 'wyzi-business-finder' );?></th>
											<td>
												<fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Archives map My Location', 'wyzi-business-finder' );?></th>
											<td>
												<fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Business Archives content', 'wyzi-business-finder' );?></th>
											<td>
												<fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Hide map POI', 'wyzi-business-finder' );?></th>
											<td><fieldset>
												...
												</select><p class="description"><?php esc_html_e( 'Hide points of interest on single business page and archives maps', 'wyzi-business-finder' );?>.</p></fieldset>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Favorite Business Post Email', 'wyzi-business-finder' );?></th>
											<td><fieldset>
												...
												</select><p class="description"><?php esc_html_e( 'Send users daily emails containing their favourited businesses\' posts.', 'wyzi-business-finder' );?>.</p></fieldset>
											</td>
										</tr>

										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Switch Sidebars', 'wyzi-business-finder' );?></th> 
											<td>
										...
										echo esc_attr( get_option( 'wyz_business_old_single_permalink' ) ); ?>"/><p class="description"><?php esc_html_e( 'A rewrite for the business cpt name', 'wyzi-business-finder' );?></p></fieldset></td>
										</tr>
										<tr valign="top">
										<th scope="row"><?php esc_html_e( 'Business tag permalink name', 'wyzi-business-finder' );?></th> 
										<td><fieldset><input type="text" class="regular-text" name="wyz_business_tags_new_single_permalink" value="<?php
										echo esc_attr( get_option( 'wyz_business_tags_old_single_permalink' ) ); ?>"/><p class="description"><?php esc_html_e( 'A rewrite for the business_tags permalink name', 'wyzi-business-finder' );?></p></fieldset></td>
										</tr>
										<tr valign="top">
										<th scope="row"><?php esc_html_e( 'Business Category slug Name', 'wyzi-business-finder' );?></th> 
										<td><fieldset><input type="text" class="regular-text" name="wyz_business_category_new_permalink" value="<?php
										echo esc_attr( get_option( 'wyz_business_category_old_permalink' ) ); ?>"/><p class="description"><?php esc_html_e( 'A rewrite for the wyz_business_category slug name. Make sure not to input "category" which is a reserved category slug name to Blog Posts of WordPress by default', 'wyzi-business-finder' );?></p></fieldset></td>
										</tr>
										<tr valign="top">
										...
										<tr valign="top">
										<th scope="row"><?php esc_html_e( 'Number of loaded businesses on map', 'wyzi-business-finder' );?></th> 
										<td><fieldset><input type="text" class="regular-text" name="wyz_map_max_ajax_load" value="<?php
										echo esc_attr( get_option( 'wyz_map_max_ajax_load', 400 ) ); ?>"/><p class="description">the number of businesses to pull on each request on maps. This number depends on your server PHP memory. This is a very useful option for websites with thousands of businesses.</p></fieldset></td>
										</tr>
									</table>
									<?php
									submit_button(); ?>
						...
						case 'business_form_fields_builder':	
							...
							wp_localize_script( 'wyz_business_fields_builder_js', 'wyziBuilderData', array('partials' => plugin_dir_url( __FILE__ ) . 'businesses-and-offers/businesses/forms/registration-form-builder/partials/','ajax_url' => admin_url( 'admin-ajax.php' ),'form_data' => $wyz_business_form_builder_data, 'translations' => array( 'openMsg' => esc_html__( 'Open all Day', 'wyzi-business-finder' ), 'closedMsg' => esc_html__( 'Closed all Day', 'wyzi-business-finder' ) ) ) );
						...
						case 'registration_form_fields':?>

								<form method="post" action="options.php">
									<?php
									settings_fields( 'registration_form_fields' );
									do_settings_sections( 'registration_form_fields' );
									?>
									<table class="form-table">
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'User Dashboard Style', 'wyzi-business-finder' );?></th> 
											<td>
												<fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Verification Email', 'wyzi-business-finder' );?></th> 
											<td>
												<fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Terms and Conditions checkbox', 'wyzi-business-finder' );?></th> 
											<td>
												<fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'User data export/erase', 'wyzi-business-finder' );?></th> 
											<td>
												<fieldset>
							...
							<tr>
								<form method="post" action="options.php">
									...
									<table class="form-table">
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Disable Offers', 'wyzi-business-finder' );?></th> 
											<td><fieldset>
												...
												</select><p class="description"><?php echo esc_html__( 'Remove Offers management/submission ability from frontend.', 'wyzi-business-finder' );?>.</p></fieldset>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Allow Schedule', 'wyzi-business-finder' );?></th> 
											<td><fieldset>
												...
												</select><p class="description"><?php echo sprintf( esc_html__( 'If turned on, %s schedualling by business owners will be allowed and Imediate Publish Option will have no effect on schedualed offers', 'wyzi-business-finder' ), WYZ_OFFERS_CPT );?>.</p></fieldset>
											</td>
										</tr>
										<tr valign="top">
							...
							<tr>
								<form method="post" action="options.php">
									...
									<table class="form-table">
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Auto Vendorship', 'wyzi-business-finder' );?></th>
											<td><fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Bookable products', 'wyzi-business-finder' );?></th>
											<td><fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( 'Bookable products display', 'wyzi-business-finder' );?></th>
											<td><fieldset>
										...
										<tr valign="top">
											<th scope="row"><?php esc_html_e( '"Sold by" directs to', 'wyzi-business-finder' );?></th>
											<td><fieldset>
						...
						<tr>
								<form method="post" action="options.php">
									<?php settings_fields( 'wyz_private_msg_settings' );
									do_settings_sections( 'wyz_private_msg_settings' ); ?>
									<table class="form-table">
										<tr valign="top">
										<?php $opt = get_option( 'wyz_private_msg_status_on_off', 'off');?>
											<th scope="row"><?php esc_html_e( 'Messaging Status', 'wyzi-business-finder' );?></th> 
											<td>
												<fieldset>
										...
										<?php $opt = get_option( 'wyz_private_msg_hide_client', 'off');?>
											<th scope="row"><?php esc_html_e( 'Hide for clients', 'wyzi-business-finder' );?></th> 
											<td>
												<fieldset>
...
if ( ! function_exists( 'wyz_register_business_settings' ) ) {
	...
	function wyz_register_business_settings() {
		...
		register_setting( 'wyz_businesses_settings', 'wyz_businesses_draft_on_expiry' );
		...
		register_setting( 'wyz_businesses_settings', 'wyz_switch_sidebars_single_bus' );
...
if ( ! function_exists( 'wyz_register_registration_fields_settings' ) ) {
	...
	function wyz_register_registration_fields_settings() {
		register_setting( 'registration_form_fields', 'wyz_user_dashboard_template' );
		register_setting( 'registration_form_fields', 'wyz_reg_def_user_role' );
		register_setting( 'registration_form_fields', 'wyz_user_email_verification' );
		register_setting( 'registration_form_fields', 'wyz_terms_and_cond_checkbox' );
		register_setting( 'registration_form_fields', 'wyz_user_export_erase' );
	}
}
...
function wyz_admin_tabs( $current = 'businesses' ) {
	$tabs = array(
		...
		'business_custom_form_fields' => esc_html__( 'Custom Business Form Fields', 'wyzi-business-finder' ),
		'business_form_fields_builder' => esc_html__( 'Business Registration Form Builder', 'wyzi-business-finder'),
		'registration_form_fields' => esc_html__( 'User Registration Form Builder', 'wyzi-business-finder' ),
