...
class Messages
{
    ...
    public function __construct()
    {
        ...
        add_action( 'woocommerce_payment_complete', array( $this, 'service_purchased' ) );
    ...
    { 
        ...
        if ( ! empty( $attachment_file ) ) {
            ...
            if($is_reply) {
                ...
                update_post_meta( $parent, 'attachment_id', $attachment_id );
                update_post_meta( $parent, 'attachment_ext', $ext);
            }
        }
        ...
        if ( 1 /*check if mesage is read in frontend*/){
            ...
            if (! $is_reply )
                ...
                $message_id_for_email  = private_message_get_parent_id( $message_id );

            $message_to_reciever = str_replace( '%reciever_user_name%', $business_url , $message_to_reciever );
