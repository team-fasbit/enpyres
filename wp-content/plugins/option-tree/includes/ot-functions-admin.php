...
function ot_fetch_google_fonts( $normalize = true, $force_rebuild = false ) {
  ...
  if ( 1||$force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
    ...
    $ot_google_fonts_api_key = apply_filters( 'ot_google_fonts_api_key', 'AIzaSyCcddHbS7LMZT_-ub1WNA98iDey8W7aOVc' );
